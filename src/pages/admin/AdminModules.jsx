...
function AdminModules() {
  ...
  const goToLessons = (moduleId) => navigate(`/admin/lessons?moduleId=${moduleId}`);
    ...
    <div className="modules-page">
      <div className="page-header">
        <div>
          ...
          <p className="subtitle">Create modules, then add lessons inside them</p>
        </div>
              ...
              return (
                <div className="module-card" key={module.id}>
                  ...
                  <div className="module-nav-actions">
                    <button className="module-nav-btn wide" onClick={() => goToLessons(module.id)}>
          ...
          <div className="modal-content confirm-modal" onClick={(e) => e.stopPropagation()}>
            <div className="confirm-content">
              ...
              <div className="confirm-body">
                ...
                <p className="confirm-sub">Its lessons and student progress will also be removed.</p>
              </div>
            </div>
            <div className="modal-footer">
